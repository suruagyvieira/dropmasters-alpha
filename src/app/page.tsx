      ...
      <section className="container" style={{ minHeight: '90vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingTop: '100px' }}>
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '900px' }}>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', marginTop: '3.5rem', flexWrap: 'wrap' }}>
            <Link href="/shop" className="btn-cyber" style={{ textDecoration: 'none', padding: '18px 40px' }}>
              EXPLORAR CATALOG <ArrowRight size={20} />
            </Link>
            <Link href="/afiliados" className="glass" style={{ padding: '18px 40px', cursor: 'pointer', fontWeight: '800', border: '1px solid var(--glass-border)', textDecoration: 'none', color: '#fff', display: 'flex', alignItems: 'center', gap: '10px' }}>
              CENTRAL DE AFILIADOS <TrendingUp size={18} />
            </Link>
          </div>
        </div>
      ...
      <section className="container section" style={{ textAlign: 'center', paddingBottom: '8rem' }}>
        <div className="glass" style={{ padding: '6rem 2rem', overflow: 'hidden', position: 'relative', background: 'radial-gradient(circle at top right, rgba(139, 92, 246, 0.15) 0%, transparent 70%)' }}>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/shop" className="btn-cyber" style={{ textDecoration: 'none', padding: '20px 50px' }}>
