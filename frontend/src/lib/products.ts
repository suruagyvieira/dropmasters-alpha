...
export const MOCK_PRODUCTS: Product[] = [
    {
        ...
        demand_score: 98,
        is_viral: true,
        description: "Cancelamento de ruído ativo com IA para isolamento total.",
    ...
    },
    {
        ...
        description: "Monitoramento de saúde premium com sensor de oxigênio.",
    ...
    },
    {
        ...
        demand_score: 88,
        description: "Segurança total para seus equipamentos eletrônicos.",
        metadata: { benefits: ["Porta USB", "Material Kevlar", "Garantia Vitalícia"] }
    },
    {
        id: "prod_004",
        ...
        demand_score: 91,
        description: "Transforme qualquer ambiente com 16 milhões de cores via Alexa.",
        metadata: { benefits: ["Economia 80%", "Timer Auto", "Controle de Voz"] }
    }
];
